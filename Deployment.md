...
|   |            |                                                                            |   |
|   |   +-----------------+                                                                   |   |
|   |   | 云负载均衡 SLB  | (按流量计费 或 独享实例)                                          |   |
|   |   +--------+--------+                                                                   |   |
|   |            |                                                                            |   |
|   |   +-----------------+   内网反向代理 / 动静分离                                         |   |
|   |   |    Nginx 集群   | (ECS 4核8G x 2)                                                   |   |
|   |   +--------+--------+                                                                   |   |
|   |            |                                                                            |   |
|   |   +-----------------+   K8s 集群 / ECS 集群                                             |   |
|   |   | Spring Boot应用 | (ECS 8核16G x N，按需动态扩缩容)                                  |   |
|   |   +--------+--------+                                                                   |   |
|   |            |                                                                            |   |
|   |   +--------+--------------------------+----------------------------+                    |   |
|   |   |                                   |                            |                    |   |
|   |   v                                   v                            v                    |   |
|   | +-----------------+         +-----------------+          +-----------------+            |   |
|   | | 云数据库 MySQL  |         | 云数据库 Redis  |          | 消息队列 Kafka  |            |   |
|   | | (16核64G, 主库) |         | (Cluster, 32G)  |          | (8核32G集群)    |            |   |
|   | +-----------------+         +-----------------+          +-----------------+            |   |
|   |   |                                                                                     |   |
|   |   +-------------------> [ 云数据库 MySQL 从库 (8核32G x 2) ]                            |   |
|   +-----------------------------------------------------------------------------------------+   |
+-------------------------------------------------------------------------------------------------+
```
