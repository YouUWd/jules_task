...
// 配置文件与路径
const inputFile = 'Deployment.md';
const outputFilePDF = 'Deployment.pdf';
const tempMarkdownFile = 'temp_Deployment.md';
...
while ((match = mermaidRegex.exec(content)) !== null) {
    ...
    const finalImage = `Deployment-Mermaid-${count}.png`;
    ...
    try {
        // 使用 mmdc 渲染为高清 PNG 图片 (宽度1600, 背景白色)
        cp.execSync(`mmdc -i ${tempFile} -o ${finalImage} -w 1600 -b white`, { stdio: 'inherit' });
